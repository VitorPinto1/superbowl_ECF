...
class MySQL(object):
    ...
    def teardown_request(self, exception):
        if hasattr(g, "mysql_dbs"):
            try:
                if self.prefix in g.mysql_dbs and g.mysql_dbs[self.prefix].open:
                    g.mysql_dbs[self.prefix].close()
            except Exception as e:
                # Puedes agregar logging aquí para manejar el error más adecuadamente
                pass
